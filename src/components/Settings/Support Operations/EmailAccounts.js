...
const EmailAccounts = () => {
  ...
  //New Account Values
  const [newAccountValue, setValue] = useState({
    name: "",
    email: "",
    password: "",
                ...
                <fieldset className="border dark:border-slate-700 border-slate-500 rounded-lg p-2 px-4 flex flex-col space-y-2 dark:bg-[#25396823] bg-slate-200">
                  ...
                  <div className="flex justify-center items-center py-2">
                    ...
                    <button
                      ...
                      className="h-8 w-20 px-4 outline-none focus:outline-none hover:opacity-80 transition-all rounded-r-md bg-red-700 text-slate-100 border-l border-slate-400 font-bold tracking-wider text-xs uppercase"
                    >
                      Delete
                    </button>
                  </div>
