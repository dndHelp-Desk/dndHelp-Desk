...
const ContactsComponent = () => {
  ...
  //Component ======================================
  return (
    <div className="dark:bg-slate-800 bg-slate-200 border dark:border-slate-800 border-slate-300 mt-4 container w-[90%] md:w-full rounded-xl 2xl:w-[72rem] gap-4 flex flex-col tracking-wider relative">
