...
const MainComponent = () => {
  ...
  return (
    <div className={theme}>
      <div className="dark:bg-slate-400 bg-slate-300 w-screen min-h-screen pb-4 overflow-y-scroll no-scrollbar no-scrollbar::-webkit-scrollbar relative flex flex-col items-center">
