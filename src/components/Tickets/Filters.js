...
const Filters = () => {
  ...
  return (
    <>
      <div className="h-full dark:bg-slate-800 bg-slate-200 w-full lg:min-w-0 flex items-center rounded-xl relative">
        ...
        <input
          ...
          className="h-full w-full bg-transparent outline-none focus:outline-none dark:border-slate-800 border-slate-300 rounded-xl duration-300 text-slate-400 placeholder:text-slate-500 placeholder:text-xs text-sm pl-10"
