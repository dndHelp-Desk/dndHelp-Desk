            ...
            <div className="h-[20%] min-h-[2.5rem] p-[0.15rem] w-full flex justify-between items-center">
              <div className="h-full flex items-center">
                ...
                <abbr title="Attachment">
                  <label
                    htmlFor="picture"
                    className="w-8 h-8 border border-r-0 border-slate-200 dark:border-slate-800 rounded-l flex justify-center items-center outline-none focus:outline-none hover:opacity-80 text-slate-500 text-lg cursor-pointer"
                  >
                    <BiImageAlt />
                    <input
                      type="file"
                ...
                <abbr title="Bold ">
                  <button
                    type="button"
                    className="w-8 h-8 border border-r-0 border-slate-200 dark:border-slate-800 hidden sm:flex justify-center items-center text-base font-medium outline-none focus:outline-none hover:opacity-80 text-slate-500"
                  >
                    <span>B</span>
                  </button>
                </abbr>
                ...
                <abbr title="Italic">
                  <button
                    type="button"
                    className="w-8 h-8 border border-r-0 border-slate-200 dark:border-slate-800 hidden sm:flex justify-center items-center text-base italic font-sans outline-none focus:outline-none hover:opacity-80 text-slate-500"
                  >
                    <BsTypeItalic />
                  </button>
                </abbr>
                ...
                <abbr title="Underline">
                  <button
                    type="button"
                    className="w-8 h-8 border border-r-0 border-slate-200 dark:border-slate-800 hidden sm:flex justify-center items-center text-base font-sans outline-none focus:outline-none hover:opacity-80 text-slate-500"
                  >
                    <BsTypeUnderline />
                  </button>
                </abbr>
              ...
              <div className="flex space-x-2 items-center">
                <button
                  type="submit"
                  className="h-8 outline-none focus:outline-none focus:ring-1 focus:ring-blue-700  rounded text-lg p-2 px-4 font-semibold  text-slate-100 bg-slate-800 dark:bg-blue-700 z-[99] flex items-center space-x-1 hover:opacity-80 transition-all shadow-sm"
                >
