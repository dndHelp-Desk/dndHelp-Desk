...
const OffCanvasMenu = ({ filtersModal, setfiltersModal }) => {
  ...
  //Component ================
  return (
    <div ref={closeCanvasRef} className={`fixed left-0 top-0 bottom-0 flex justify-center h-full dark:bg-[#1e293bde] bg-slate-100 backdrop-blur-sm shadow-2xl pt-28 p-4 ${filtersModal?"z-[999]":"hidden z-[-999]"} transition-all`}>
