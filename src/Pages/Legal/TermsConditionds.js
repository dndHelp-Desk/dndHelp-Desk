      ...
      <div className="p-8 px-12 bg-white">
            ...
            >
              <span style={{ fontSize: 15 }}>
                ...
                >
                  ...
                  <bdt className="statement-end-if-in-editor"></bdt>. We will
              ...
              >
                ...
                >
                  ...
                  <bdt
                    ...
                    data-type="question"
                  >
                    dndhelpdesk@dndhelp-desk.co.za
                  </bdt>
                  <bdt className="block-component" />
                </span>
                .
                ...
                <bdt data-type="body">
                  ...
                  >
                    ...
                    >
                      ...
                      reviews should not contain offensive profanity, or
                      abusive, racist, offensive, or hate language; (3) your
                      reviews should not contain discriminatory references based
                      ...
                      post any false or misleading statements; and (8) you may
                      not organize a campaign encouraging others to post
                ...
                <bdt data-type="body">
                  ...
                  >
                    <span style={{ fontSize: 15 }}>
                      ...
                      <span style={{ lineHeight: "115%" }}> </span>
                      <span
                        style={{
                          lineHeight: "115%",
                          fontFamily: "Arial",
        ...
        <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="block-component" />
              <bdt className="question">South Africa</bdt>
              <bdt className="statement-end-if-in-editor" />.{" "}
              <bdt className="question">dndhelp-desk</bdt> and yourself
            ...
            <bdt data-type="conditional-block">
              <bdt data-type="body">
                <div
                  ...
                  style={{ lineHeight: "1.5" }}
                >
                  <span style={{ fontSize: 15 }}>To expedite r</span>
                  <span
                    style={{
                      fontSize: 15,
                      lineHeight: "16.8667px",
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            arbitrators shall be <bdt className="question">four (4)</bdt>. The
            seat, or legal place, of arbitration shall be{" "}
            <bdt className="block-component" />
            <bdt className="question">Johannesburg</bdt>,{" "}
            <bdt className="block-component" />
            <bdt className="question">South Africa</bdt>
            <bdt className="statement-end-if-in-editor" />
            <bdt className="else-block" />. The language to be used in the
            arbitral proceedings shall be{" "}
            <bdt className="question">English</bdt>. The governing law of the
                            ...
                            <bdt data-type="if">
                              <bdt data-type="conditional-block">
                                <bdt data-type="body">
                                  ...
                                  DURING THE{" "}
                                  <bdt className="question">THREE (3)</bdt>{" "}
        ...
        >
          <strong>
            <span style={{ fontSize: 19 }}>27. MISCELLANEOUS</span>
          </strong>
        </div>
        <div className="MsoNormal" style={{ lineHeight: 1 }}>
          <br />
...
export default TermsConditionds;
