  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full overflow-hidden p-4">
        ...
        <div>
          <div
            className={`h-10 w-full border border-slate-300 dark:border-slate-600 mt-4 m-auto grid grid-cols-3 rounded text-xs uppercase text-slate-800 dark:text-slate-300 font-semibold`}
          >
            {/**Days ========= */}
          ...
          <div className="flex justify-center w-full mt-4">
            <button
              ...
              className="px-6 py-2 rounded-sm bg-slate-800 dark:bg-indigo-700 text-slate-50 text-[0.7rem] uppercase flex justify-center items-center space-x-2 hover:opacity-80 transition-all duration-200"
            >
