...
const SupportOperations: FC = () => {
  ...
  //Component =================
  return (
    <section className="bg-transparent w-full h-full grid grid-rows-9 gap-4 overflow-hidden overflow-y-scroll no-scrollbar no-scrollbar::-webkit-scrollbar px-6">
