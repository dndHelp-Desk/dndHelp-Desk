  ...
  return (
    <div ref={pickerRef} className="relative">
      <button
        ...
        className="h-9 w-[8rem] bg-white dark:bg-slate-800 outline-none focus:outline-none focus:border-blue-600 dark:focus:border-blue-600 border border-slate-300 dark:border-slate-700 rounded-sm flex items-center justify-start px-2 relative"
      >
